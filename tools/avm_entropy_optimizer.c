...
// A binary executable avm_entropy_optimizer will be generated in tools/. It
...
//
// Command line: ./avm_entropy_optimizer [directory of the count file]
//
...
typedef unsigned int avm_count_type;
// A log file recording parsed counts
static FILE *logfile;  // TODO(yuec): make it a command line option

static void counts_to_cdf(const avm_count_type *counts, avm_cdf_prob *cdf,
                          int modes) {
...
static int parse_counts_for_cdf_opt(avm_count_type **ct_ptr,
  ...
  if (dim_of_cts == 1) {
    ...
    avm_cdf_prob cdfs[CDF_MAX_SIZE];
    avm_count_type *counts1d = *ct_ptr;

    counts_to_cdf(counts1d, cdfs, total_modes);
    (*ct_ptr) += total_modes;

    if (tabs > 0) fprintf(probsfile, "%*c", tabs * SPACES_PER_TAB, ' ');
    fprintf(probsfile, "AVM_CDF%d(", total_modes);
 ...
 */
static void optimize_cdf_table(avm_count_type *counts, FILE *const probsfile,
...
*/
static void optimize_cdf_table_var_modes_2d(avm_count_type *counts,
...
/* See optimize_cdf_table for usage.
   modes_each_ctx: input symbol counts per each context row
*/
static void optimize_cdf_table_var_modes_3d(avm_count_type *counts,
                                            FILE *const probsfile,
                                            int dim_of_cts, int *cts_each_dim,
                                            int *modes_each_ctx, char *prefix,
                                            int has_rom_multiplier,
...
/* See optimize_cdf_table for usage.
   modes_each_ctx: input symbol counts per each context row
*/
static void optimize_cdf_table_var_modes_4d(avm_count_type *counts,
                                            FILE *const probsfile,
                                            int dim_of_cts, int *cts_each_dim,
                                            int *modes_each_ctx, char *prefix,
                                            int has_rom_multiplier,
...
static void optimize_cdf_table_var_modes_3d_inner(
    avm_count_type *counts, FILE *const probsfile, int dim_of_cts,
...
int main(int argc, const char **argv) {
  ...
  if (mem_wanted) {
    ...
    logfile = fopen("avm_entropy_optimizer_parsed_counts.log", "w");
    if (logfile == NULL) {
  ...
  optimize_cdf_table(&fc.mrl_index[0][0], probsfile, 2, cts_each_dim,
                     "static const avm_cdf_prob default_mrl_index_cdf"
  ...
  optimize_cdf_table(&fc.multi_line_mrl[0][0], probsfile, 2, cts_each_dim,
                     "static const avm_cdf_prob default_multi_line_mrl_cdf"
  ...
  optimize_cdf_table(
      ...
      "static const avm_cdf_prob default_cctx_type_cdf[CDF_SIZE(CCTX_TYPES)]",
  ...
  optimize_cdf_table(&fc.region_type[0][0], probsfile, 2, cts_each_dim,
                     "static avm_cdf_prob default_region_type_cdf"
  ...
  optimize_cdf_table(
      ...
      "static avm_cdf_prob default_do_split_cdf"
  ...
  optimize_cdf_table(
      ...
      "static avm_cdf_prob default_do_square_split_cdf"
  ...
  optimize_cdf_table(
      ...
      "static avm_cdf_prob default_rect_type_cdf"
      "[PARTITION_STRUCTURE_NUM][PARTITION_CONTEXTS][CDF_SIZE(2)]",
  ...
  optimize_cdf_table(&fc.do_ext_partition[0][0][0][0], probsfile, 4,
                     cts_each_dim,
                     "static avm_cdf_prob default_do_ext_partition_cdf"
  ...
  optimize_cdf_table(
      ...
      "static avm_cdf_prob default_do_uneven_4way_partition_cdf"
  ...
  optimize_cdf_table(&fc.delta_q_cnts[0], probsfile, 1, cts_each_dim,
                     "static avm_cdf_prob default_delta_q_cdf"
  ...
  optimize_cdf_table(&fc.stx_cnts[0][0][0], probsfile, 3, cts_each_dim,
                     "static avm_cdf_prob default_stx_cdf"
  ...
  optimize_cdf_table(&fc.stx_set_cnts[0], probsfile, 1, cts_each_dim,
                     "static avm_cdf_prob default_most_probable_stx_set_cdf"
  ...
  optimize_cdf_table(
      ...
      "static avm_cdf_prob default_pb_mv_most_probable_precision_cdf"
  ...
  optimize_cdf_table(&fc.pb_mv_precision_cnts[0][0][0], probsfile, 3,
                     cts_each_dim,
                     "static avm_cdf_prob default_pb_mv_precision_cdf"
  ...
  for (int ibc = 0; ibc < 2; ibc++) {
    ...
    optimize_cdf_table(&nmvc_cnts->joint_shell_set_cnts[0], probsfile, 1,
                       cts_each_dim,
                       "static avm_cdf_prob joint_shell_set_cdf_placeholder"
                       "[CDF_SIZE(2)]",
                       0, &total_count, 0, mem_wanted, "Inter");
    ...
    optimize_cdf_table(&nmvc_cnts->joint_shell_class_0_cnts[0][0], probsfile, 2,
                       cts_each_dim,
                       "static avm_cdf_prob joint_shell_class_0_cdf_placeholder"
    ...
    optimize_cdf_table(&nmvc_cnts->joint_shell_class_1_cnts[0][0], probsfile, 2,
                       cts_each_dim,
                       "static avm_cdf_prob joint_shell_class_1_cdf_placeholder"
    ...
    optimize_cdf_table(
        ...
        cts_each_dim,
        "static avm_cdf_prob joint_shell_last_two_classes_cdf_placeholder"
        "[CDF_SIZE(2)]",
        0, &total_count, 0, mem_wanted, "Inter");
    ...
    optimize_cdf_table(
        ...
        cts_each_dim,
        "static avm_cdf_prob shell_offset_low_class_cdf_placeholder"
        "[2][CDF_SIZE(2)]",
        0, &total_count, 0, mem_wanted, "Inter");
    ...
    optimize_cdf_table(&nmvc_cnts->shell_offset_class2_cnts[0][0], probsfile, 2,
                       cts_each_dim,
                       "static avm_cdf_prob shell_offset_class2_cdf_placeholder"
                       "[3][CDF_SIZE(2)]",
                       0, &total_count, 0, mem_wanted, "Inter");
    ...
    optimize_cdf_table(
        ...
        cts_each_dim,
        "static avm_cdf_prob shell_offset_other_class_cdf_placeholder"
    ...
    optimize_cdf_table(
        ...
        "static avm_cdf_prob col_mv_greater_flags_cdf_placeholder"
    ...
    optimize_cdf_table(&nmvc_cnts->col_mv_index_cnts[0][0], probsfile, 2,
                       cts_each_dim,
                       "static avm_cdf_prob col_mv_index_cdf_placeholder"
    ...
    if (!ibc) {
      ...
      optimize_cdf_table(&nmvc_cnts->amvd_joints_cnts[0], probsfile, 1,
                         cts_each_dim,
                         "static avm_cdf_prob amvd_joints_cdf_placeholder"
                         "[CDF_SIZE(MV_JOINTS)]",
                         0, &total_count, 0, mem_wanted, "Inter");
    }
    ...
    for (int mvd_comp = 0; mvd_comp < 2; mvd_comp++) {
      if (!ibc) {
        ...
        optimize_cdf_table(
            ...
            1, cts_each_dim,
            "static avm_cdf_prob amvd_indices_cdf_placeholder"
      ...
      optimize_cdf_table(&nmvc_cnts->mvd_comp_cnts[mvd_comp].sign_cnts[0],
                         ...
                         "static avm_cdf_prob sign_cdf_placeholder"
                         "[CDF_SIZE(2)]",
                         0, &total_count, 0, mem_wanted, "Inter");
    }  // for (int mvd_comp = 0; mvd_comp < 2; mvd_comp++)
  }  // for (int ibc = 0; ibc < 2; ibc++)
  ...
  optimize_cdf_table(&fc.seg_tree_cnts[0], probsfile, 1, cts_each_dim,
                     "static avm_cdf_prob default_seg_tree_cdf"
  ...
  optimize_cdf_table(&fc.segment_pred_cnts[0][0], probsfile, 2, cts_each_dim,
                     "static avm_cdf_prob default_segment_pred_cdf"
  ...
  optimize_cdf_table(&fc.spatial_pred_seg_tree_cnts[0][0], probsfile, 2,
                     cts_each_dim,
                     "static avm_cdf_prob default_spatial_pred_seg_tree_cdf"
                     "[SEG_TEMPORAL_PRED_CTXS][CDF_SIZE(2)]",
                     0, &total_count, 0, mem_wanted, "Inter");
  ...
  optimize_cdf_table(&fc.cwp_idx_cnts[0][0][0], probsfile, 3, cts_each_dim,
                     "static const avm_cdf_prob default_cwp_idx_cdf"
  ...
  optimize_cdf_table(&fc.use_optflow[0][0], probsfile, 2, cts_each_dim,
                     "static const avm_cdf_prob default_use_optflow_cdf"
  ...
  optimize_cdf_table(&fc.compound_type[0], probsfile, 1, cts_each_dim,
                     "static const avm_cdf_prob default_compound_type_cdf"
  ...
  optimize_cdf_table(&fc.warp_delta_param[0][0], probsfile, 2, cts_each_dim,
                     "static const avm_cdf_prob default_warp_delta_param_cdf"
  ...
  optimize_cdf_table(
      ...
      "static const avm_cdf_prob default_warp_delta_param_high_cdf"
  ...
  optimize_cdf_table(&fc.identity_row_y_cnts[0][0], probsfile, 2, cts_each_dim,
                     "const avm_cdf_prob default_identity_row_cdf_y"
  ...
  optimize_cdf_table(&fc.identity_row_uv_cnts[0][0], probsfile, 2, cts_each_dim,
                     "const avm_cdf_prob default_identity_row_cdf_uv"
                     "[PALETTE_ROW_FLAG_CONTEXTS][CDF_SIZE(3)]",
                     0, &total_count, 0, mem_wanted, "Coefficients");
  ...
  optimize_cdf_table_var_modes_3d(
      ...
      "const avm_cdf_prob default_palette_y_color_index_cdf[PALETTE_SIZES]"
  ...
  optimize_cdf_table_var_modes_3d(
      ...
      palette_color_indexes_each_ctx,
      "const avm_cdf_prob default_palette_uv_color_index_cdf[PALETTE_SIZES]"
      "[PALETTE_COLOR_INDEX_CONTEXTS][CDF_SIZE(PALETTE_COLORS)]",
      0, &total_count, mem_wanted, "Coefficients");
  ...
  optimize_cdf_table(&fc.comp_group_idx[0][0], probsfile, 2, cts_each_dim,
                     "static const avm_cdf_prob default_comp_group_idx_cdfs"
  ...
  optimize_cdf_table(&fc.txb_skip[0][0][0][0], probsfile, 4, cts_each_dim,
                     "static const avm_cdf_prob "
                     "av2_default_txb_skip_cdfs[TOKEN_CDF_Q_CTXS][TX_SIZES]"
  ...
  optimize_cdf_table(&fc.v_txb_skip[0][0][0], probsfile, 3, cts_each_dim,
                     "static const avm_cdf_prob "
                     "av2_default_v_txb_skip_cdfs[TOKEN_CDF_Q_CTXS]"
  ...
  optimize_cdf_table(&fc.eob_extra[0][0], probsfile, 2, cts_each_dim,
                     "static const avm_cdf_prob av2_default_eob_extra_cdfs"
                     "[TOKEN_CDF_Q_CTXS]"
                     "[CDF_SIZE(2)]",
                     1, &total_count, 0, mem_wanted, "Coefficients");
  ...
  optimize_cdf_table(
      ...
      "static const avm_cdf_prob av2_default_eob_multi16_cdfs"
  ...
  optimize_cdf_table(
      ...
      "static const avm_cdf_prob av2_default_eob_multi32_cdfs"
  ...
  optimize_cdf_table(
      ...
      "static const avm_cdf_prob av2_default_eob_multi64_cdfs"
  ...
  optimize_cdf_table(
      ...
      "static const avm_cdf_prob av2_default_eob_multi128_cdfs"
  ...
  optimize_cdf_table(
      ...
      "static const avm_cdf_prob av2_default_eob_multi256_cdfs"
  ...
  optimize_cdf_table(
      ...
      "static const avm_cdf_prob av2_default_eob_multi512_cdfs"
  ...
  optimize_cdf_table(
      ...
      "static const avm_cdf_prob av2_default_eob_multi1024_cdfs"
  ...
  optimize_cdf_table(&fc.coeff_lps_multi_uv[0][0][0], probsfile, 3,
                     cts_each_dim,
                     "static const avm_cdf_prob "
                     "av2_default_coeff_lps_multi_uv_cdfs[TOKEN_CDF_Q_CTXS]"
  ...
  optimize_cdf_table(&fc.coeff_base_ph_multi[0][0][0], probsfile, 3,
                     cts_each_dim,
                     "const avm_cdf_prob "
                     "av2_default_coeff_base_ph_cdfs[TOKEN_CDF_Q_CTXS][COEFF_"
  ...
  optimize_cdf_table(&fc.coeff_lps_lf_multi[0][0][0], probsfile, 3,
                     cts_each_dim,
                     "static const avm_cdf_prob "
                     "av2_default_coeff_lps_lf_multi_cdfs[TOKEN_CDF_Q_CTXS]"
  ...
  optimize_cdf_table(&fc.coeff_lps_multi[0][0][0], probsfile, 3, cts_each_dim,
                     "static const avm_cdf_prob "
                     "av2_default_coeff_lps_multi_cdfs[TOKEN_CDF_Q_CTXS]"
